...
(best_sol_3, objective_val_3) = alg_3.optimize(fun1D, 1, 1000, 1, 0)
...
(best_sol_3, objective_val_3) = alg_3.optimize(fun2D, 2, 1000, 1, 0)
(best_sol_4, objective_val_4) = alg_4.optimize(fun2D, 2, 1000, 100, -100)
(best_sol_5, objective_val_5) = alg_5.optimize(fun2D, 2, 1000, 100, -100)
print(best_sol_1, objective_val_1)
print(best_sol_2, objective_val_2)
print(best_sol_3, objective_val_3)
print(best_sol_4, objective_val_4)
